...
public class SpiderMan extends Kit {
	...
	public ItemStack[] kitItems() {
		...
		ItemStack[] items = { new ItemStack(Material.STRING, 16), summonSpider };
		return items;
	}
	...
	public ItemStack[] kitArmour() {
		...
		helmet = Utilities.colourStack(helmet, Color.RED);  
		chestplate = Utilities.colourStack(chestplate, Color.BLACK);
		leggings = Utilities.colourStack(leggings, Color.BLACK);
		boots = Utilities.colourStack(boots, Color.BLACK);
