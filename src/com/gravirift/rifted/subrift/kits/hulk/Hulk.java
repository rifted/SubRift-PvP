...
public class Hulk extends Kit {
	...
	public ItemStack[] kitItems() {
		ItemStack[] items = { new ItemStack(Material.WOOD_SWORD) };
		return items;
	}
	...
	public ItemStack[] kitArmour() {
		...
		helmet = Utilities.colourStack(helmet, Color.GREEN);  
		chestplate = Utilities.colourStack(chestplate, Color.GREEN);
		leggings = Utilities.colourStack(leggings, Color.GREEN);
		boots = Utilities.colourStack(boots, Color.GREEN);
